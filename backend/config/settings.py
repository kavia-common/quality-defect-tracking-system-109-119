...
# Frontend fetch wrapper uses `credentials: "include"`. Even if we don't rely on cookies
# today, enabling credentials prevents inconsistent browser CORS behavior.
